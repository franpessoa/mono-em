...
Apesar disso, espera-se que ela tenha sido suficiente tanto como exposição técnica, quanto como crítica à organização social produzida por essas técnicas, quanto como apresentação de um modelo alternativo de produção que têm a chance de superar as contradições impostas pelas indústrias do Vale do Silício.
