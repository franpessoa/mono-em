...
\begin{quoting}
Para domínios como imagens, linguagem e vídeo, a alta dimensionalidade do problema e o tamanho maior do conjunto de dados modernos torna difícil garantir que todas as características foram sistematicamente rotuladas.
Mesmo se podemos rotulado em escala atributos sensíveis como gênero e raça, algoritmos ainda podem usar variáveis \textit{proxy} para reconstruir o rótulo proibido.
