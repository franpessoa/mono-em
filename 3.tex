...
Com isso, é possível refletir uma ação criminosa digital em uma consequência física para o ator envolvido.
Possibilita-se, assim, que as mesmas abordagens coercivas estatais usadas em meios físicos possam também ser utilizadas em meios digitais.
...
São elas o Marco Civil da Internet (MCI), de 2014, e a Lei Geral de Proteção de Dados Pessoais (LGPD), de 20XX.
...
Esses dois incisos colocam algumas 
...
Assim, respeitadas as boas-práticas de transparência e segurança desses dados delimitadas na lei, a coleta de dados pode ocorrer livremente desde que seja voluntária; a ênfase passa a ser nas circunstâncias que a lei proíbe.
