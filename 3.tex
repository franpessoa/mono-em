...
A própria narrativa fatalista de que as máquinas vão dominar a humanidade, \textit{à la} Matrix, cai nessa falácia.
...
Apesar disso, foi o Estado pequeno e desregulatório dos anos 80 e 90 que permitiu a consolidação das indústrias do Vale do Silício no meio digital, sem interferência estatal e com poucos impostos a pagar.
...
É difícil, para o olho criado com intermédio da ideologia do Vale do Silício, pensar em um método alternativo de produção; em especial dado que a mercadoria digital atingiu um nível considerável de fetiche (no sentido marxista de \textit{feitiço}), de modo que a maioria dos indivíduos não reflete sobre as condições materiais de trabalho em que ela foi produzida.
